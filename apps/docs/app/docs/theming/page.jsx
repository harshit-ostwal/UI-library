...
function ColorSwatch({ name, className }) {
  return (
    <div className="flex items-center gap-3">
      <div className={`w-8 h-8 rounded-md border border-border ${className}`} />
  ...
  return (
    <div className="container max-w-4xl px-4 py-10 mx-auto">
      ...
      <div className="mb-12">
        ...
        <DocsDescription>
          shery-ui uses CSS variables for theming. Customize colors, radius,
          scaling, and typography to match your brand — with full dark mode
          support built in.
        </DocsDescription>
      </div>
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          . Edit it to configure your accent color, gray palette, border radius,
          and more — then regenerate the CSS tokens.
        </p>
  ...
  fontFamily: {
    ...
    mono: undefined,
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          All tokens are emitted as CSS custom properties and consumed by every
          component. The variables live in{" "}
          <code className="font-mono text-sm bg-muted px-1.5 py-0.5 rounded">
        ...
        <p className="mb-4 text-muted-foreground">
          You can also override any token directly for one-off customizations:
        </p>
...
.dark {
  --color-accent-9:  oklch(68% 0.18 264);
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          The accent color drives buttons, links, focus rings, and interactive
          highlights. Choose the one that best matches your brand.
        </p>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                ...
                <OptionRow key={val} value={val} description={desc} />
              ))}
            </tbody>
          </table>
        </div>
        ...
        <p className="mb-4 text-muted-foreground">
          The gray palette controls backgrounds, borders, and secondary text.
          Pick a tint that complements your accent.
        </p>
        <div className="my-4 overflow-x-auto border rounded-lg border-border">
          <table className="w-full text-sm">
            <thead>
        ...
        <p className="text-muted-foreground">
          Status colors are used for alerts, badges, and form validation. The
          defaults are intentionally semantic — change them only if your brand
          requires it.
        </p>
...
warning: 'amber'   // Caution, warnings`}</CodeBlock>
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          setting controls how rounded components appear across the entire
          library.
        </p>
        <div className="my-4 overflow-x-auto border rounded-lg border-border">
          <table className="w-full text-sm">
        ...
        <p className="mb-3 text-muted-foreground">
          Each preset maps to a 6-step CSS variable scale you can use directly
          in Tailwind:
        </p>
...
<div className="rounded-6">Largest / pill</div>`}</CodeBlock>
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          option is a global size multiplier that affects font sizes, line
          heights, and component heights simultaneously.
        </p>
        <div className="my-4 overflow-x-auto border rounded-lg border-border">
          <table className="w-full text-sm">
            <thead>
            ...
            <tbody>
              ...
              />
              <OptionRow value="95%" description="Slightly compact layouts" />
              <OptionRow
                value="100%"
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          Override the default system font stacks with custom web fonts by
          setting{" "}
          <code className="font-mono text-sm bg-muted px-1.5 py-0.5 rounded">
            fontFamily
          </code>{" "}
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          All design tokens are mapped into your Tailwind config so you can use
          them as utility classes:
        </p>
