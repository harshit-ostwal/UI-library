    ...
    <div className="container max-w-4xl px-4 py-10 mx-auto">
      ...
      <div className="mb-12">
        ...
        <DocsDescription>
          ...
          CLI to initialize your project and add components with a single
          command.
        </DocsDescription>
      </div>
      ...
      <DocsSection>
        ...
        <p className="text-sm text-muted-foreground">Or install it globally:</p>
      ...
      <DocsSection>
        ...
        <ul className="mb-6 space-y-2 list-disc list-inside text-muted-foreground">
          <li>Auto-detects your framework (Next.js, Vite, Remix, Astro)</li>
          <li>
          ...
          <li>Prompts for CSS path, Tailwind config, and import aliases</li>
          <li>
            Creates{" "}
            <code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">
              shery-ui.json
          ...
          options={[
            {
              flag: "-y, --yes",
              default: "false",
              description: "Skip all confirmation prompts and use defaults",
            },
            {
              flag: "--cwd <path>",
              default: "process.cwd()",
    ...
    "lib": "@/lib"
      ...
      <DocsSection>
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          to determine where to write files and which import aliases to use.
        </p>
        ...
        <ul className="space-y-2 list-disc list-inside text-muted-foreground">
          ...
          <li>Rewrites internal imports to match your configured aliases</li>
          <li>Extracts and installs required npm packages automatically</li>
          <li>
            Detects your package manager (pnpm / bun / yarn / npm) from
            lockfiles
          </li>
          <li>
            Falls back to interactive multi-select when no component names are
            given
          </li>
        </ul>
      </DocsSection>
      ...
      <DocsSection>
        ...
        <div className="px-4 py-3 font-mono text-sm border rounded-lg border-border bg-muted/20 text-muted-foreground">
          <p>
            <span className="text-cyan-600 dark:text-cyan-400">accordion</span>
            {"                "}A vertically stacked set of interactive
            headings.
          </p>
          <p>
            <span className="text-cyan-600 dark:text-cyan-400">alert</span>
            {"                    "}Displays a callout for important user-facing
            messages.
          </p>
          <p>
            <span className="text-cyan-600 dark:text-cyan-400">button</span>
            {"                   "}Displays a button or a component that looks
            like a button.
          </p>
